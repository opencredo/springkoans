...
public class ConfigurationKoan extends TestCase {
    ...
    public void testInjectingString() {
    ...
    public void testInjectingInteger() {
    ...
    public void testInjectingCustomType() {
	...
	public void testInjectingNonGenericList() {
    ...
    public void testInjectingGenericList() {
    ...
    public void testInjectingGenericMap() {
    ...
    public void testInjectingProperties() {
